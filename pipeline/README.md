...
* [MQTTPublish](../mqtt/mqttpublish.py) Beispiel in mbed Studio importieren und ca. auf Zeile 23 den `hostname` mit der IP-Adresse auswechseln wo der Mosquitto Server läuft. 
...
Für Details siehe das [MQTTPublish](../mqtt/mqttpublish.py) Beispielprogramm.
